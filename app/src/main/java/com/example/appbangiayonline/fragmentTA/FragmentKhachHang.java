...
//        input_diachi.setVisibility(View.VISIBLE);
        inputLayout_diachi.setVisibility(View.VISIBLE);
        ...
        txtTitel.setText("Thêm khách hàng");
        AlertDialog dialog = builder.create();

        btnThem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String hoten,taikhoan,matkhau,email,sdt,diachi;
                ...
                diachi = input_diachi.getText().toString();
                if (isValid(hoten,taikhoan,matkhau,sdt,email,diachi)){
                    dialog.dismiss();
                }
            }
        });
    ...
    public boolean isValid(String hoten,String taikhoan, String matkhau,String sdt,String email,String diachi) {
...
//                    String hoten, String taikhoan, String matkhau, String email, String sdt
            int check = dao.newKhachHang(hoten, taikhoan, matkhau, sdt, email,diachi);
            if (check == 0) {
